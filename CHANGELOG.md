...
- [ ] Known: joining a world with this mod installed sets your sky to permanent daylight and hides the sun, moon, stars and clouds. There is no setting for it and no way to decline; it is per-player and re-applied on every join, so it stops as soon as a version without it is installed. It exists for the Codecube game, whose building world has no day/night cycle, and it should be that game's business rather than this mod's - what happens to it is not yet decided
